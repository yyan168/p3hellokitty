...
function drawScene() {
  ...
  if (pageNum == 1) {
    ...
    let t = 'I believe every girl in her childhood would definitely love Hello Kitty, this cartoon flip phone was one of my earlier cell phone, and I was super into it !'
